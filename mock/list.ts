          ...
          list: [
            {
              ...
              name: "Certificado SSL libro asasa",
              description:
                "El certificado SSL también se denomina certificado de servidor. Tencent Cloud le proporciona un servicio integral para certificados, que incluye la solicitud, gestión e implementación de certificados gratuitos y de pago."
            },
            {
              index: 2,
              isSetup: false,
            ...
            },
            {
              ...
              name: "CVM",
              description:
                "El disco en la nube le proporciona servicios de almacenamiento persistentes a nivel de bloque de datos para CVM. Los datos en el disco de la nube se redundan automáticamente con múltiples copias en la zona de disponibilidad."
            },
            {
              index: 4,
              isSetup: false,
              ...
              description:
                "La base de datos en la nube MySQL proporciona a los usuarios servicios de bases de datos en la nube de nivel empresarial que son seguros, confiables, de excelente rendimiento y fáciles de mantener."
            },
            {
              index: 5,
              isSetup: true,
              ...
              name: "CachingAsyncRoutesertificado SSL",
              description:
                "La base de datos en la nube MySQL proporciona a los usuarios servicios de bases de datos en la nube de nivel empresarial que son seguros, confiables, de excelente rendimiento y fáciles de mantener."
            },
            {
              ...
              type: 3,
              banner: "https://tdesign.gtimg.com/tdesign-pro/ssl.jpg",
              name: "Cortafuegos en la nube T-Sec",
              description:
                "El producto Tencent Security Cloud Firewall es un producto de firewall SaaS desarrollado independientemente por el equipo de seguridad en la nube de Tencent basado en las ventajas de la nube nativa. No requiere clientes, ni clientes, ni clientes, ni clientes, ni clientes, ni clientes, ni clientes, ni clientes. ."
            },
            {
              index: 7,
              isSetup: false,
