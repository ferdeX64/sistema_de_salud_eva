            ...
            <div class="flex items-center justify-around">
              ...
              {props.tableRef?.size ? (
                <>
                  <el-tooltip
                    effect="dark"
                    content={isExpandAll.value ? "colapso" : "inauguración"}
                    placement="top"
                  >
                    <ExpandIcon
                      class={["w-[16px]", iconClass.value]}
              ...
              <el-tooltip effect="dark" content="Actualizar" placement="top">
                <RefreshIcon
                  class={[
                    "w-[16px]",
                    iconClass.value,
              ...
              <el-divider direction="vertical" />
              <el-tooltip effect="dark" content="Tamaño de celdas" placement="top">
