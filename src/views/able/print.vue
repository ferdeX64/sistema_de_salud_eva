    ...
    <template #header>
      <div class="card-header">
        <span class="font-medium"
          >Funciones de impresión (informes, gráficos, imágenes)</span
        >
        <div>
          ...
          <el-button size="small" type="primary" @click="onPrint"> imprimir </el-button>
        </div>
      </div>
    </template>
    <el-row :gutter="24">
      ...
      >
        <p class="font-medium pt-1">Imagen</p>
        <img
