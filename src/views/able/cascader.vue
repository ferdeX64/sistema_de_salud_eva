...
<template>
  <el-card shadow="never">
    <template #header> Selector regional de cascadas </template>
    <el-row :gutter="20">
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center">
          <span class="imp">
            1. Enlace secundario (sin la opción "todos")
            <el-cascader
          ...
          <div class="leading-10">
            <div>Valores vinculantes:{{ selectedOptions1 }}</div>
            <div>
              Código de área en caracteres chinos:
              {{ CodeToText[selectedOptions1[0]] }},
              {{ CodeToText[selectedOptions1[1]] }}
            </div>
            <div>
              Kanji a código de área:
              {{
                convertTextToCode(
                  CodeToText[selectedOptions1[0]],
                  CodeToText[selectedOptions1[1]]
      ...
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center mt-3">
          <span class="imp">
            2. Enlace secundario (con la opción "todos")
            <el-cascader
          ...
          <div class="leading-10">
            <div>Valores vinculantes:{{ selectedOptions3 }}</div>
            <div>
              Código de área en caracteres chinos:
      ...
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center mt-3">
          <span class="imp">
            3. Vinculación de tres niveles (sin la opción "todos")
            <el-cascader
              :options="regionData"
          ...
          <div class="leading-10">
            <div>Valores vinculantes:{{ selectedOptions2 }}</div>
            <div>
              Código de área en caracteres chinos:
      ...
      <el-col :xl="12" :lg="12" :md="24" :sm="24" :xs="24">
        <div class="flex flex-col items-center justify-center mt-3">
          <span class="imp">
            4. Vinculación de tres niveles (con "todas las opciones")
            <el-cascader
          ...
          <div class="leading-10">
            <div>Valores vinculantes:{{ selectedOptions4 }}</div>
            <div>
              Código de área en caracteres chinos:
