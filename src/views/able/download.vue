...
<template>
  <el-card shadow="never">
    <template #header>
      <span class="font-medium">Función de descarga de archivos</span>
    </template>
    <div class="flex flex-wrap">
      <el-button
        ...
        "
      >
        Descargar imágenes en línea
      </el-button>

      <el-button @click="downloadByBase64(base64, 'test-base64.png')">
        Descargar imágenes basadas en base64
      </el-button>
      ...
      <el-button
        ...
        "
      >
        Descargar el archivo según la dirección del archivo
      </el-button>

      <el-button @click="down">
        Descarga según el flujo de archivos de la interfaz backend
      </el-button>
    </div>
  </el-card>
</template>
