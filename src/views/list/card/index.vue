...
const handleDeleteItem = (product) => {
  ElMessageBox.confirm(
    product
      ? `Confirme que tras la eliminación, toda la información del producto en ${product.name} se borrará y no se podrá recuperar.`
      : "",
    ...
    .then(() => {
      message("Eliminado con éxito", { type: "success" });
    })
    .catch(() => {});
};
