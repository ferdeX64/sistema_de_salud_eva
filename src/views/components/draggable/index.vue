    ...
    <template #header>
      <div class="card-header">
        <span class="font-medium">
          Componente de arrastrar y soltar de código abierto
          <el-link
      ...
      <el-row :gutter="25">
        <el-col :xs="25" :sm="8" :md="8" :lg="8">
          <el-card shadow="never">
            <template #header>
              <div class="card-header">
                <span>Arrastrar y soltar lista de cuadrícula</span>
              </div>
            </template>
            <draggable
              v-model="gridLists"
        ...
        <el-col :xs="25" :sm="8" :md="8" :lg="8">
          <el-card shadow="never">
            <template #header>
              <div class="card-header">
                <span>arrastrar y soltar en una sola columna </span>
              </div>
            </template>
            <!-- 单列拖拽 -->
            <draggable
        ...
        <el-col :xs="25" :sm="8" :md="8" :lg="8">
          <el-card shadow="never">
            <template #header>
              <div class="card-header">
                <span
                  >Arrastrar y soltar para intercambiar las posiciones de los
                  elementos</span
                >
              </div>
            </template>
