    ...
    <template #header>
      <div class="card-header">
        <span class="font-medium">
          JSON, utilizando el código abierto
          <el-link
        ...
        <span class="font-medium">
          Por supuesto, también tenemos una recomendación de componente editor de código (que no vamos a demostrar aquí) que utiliza el código abierto
          <el-link
